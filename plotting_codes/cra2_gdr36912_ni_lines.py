...
final_ni_fe = final_abund['NII_FE'][final_abund['STAR']=='cra2_gdr36912'][0]
final_ni = logeps_ni[final_abund['STAR']=='cra2_gdr36912'][0]
...
for star_name in star_list:
    ...
    for plot_i, line in enumerate(lines):
        ...
        ax.plot(obs_spec.wavelength, obs_spec.flux, c='k', lw=2.0, label='Cra II GDR3 6912')
