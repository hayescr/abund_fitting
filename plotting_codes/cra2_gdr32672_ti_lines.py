...
logeps_ti = final_abund['TIII_FE'] + final_abund['FEII_H'] + solar_abundances['Ti']
final_ti_fe = final_abund['TIII_FE'][final_abund['STAR']=='cra2_gdr32672'][0]
final_ti = logeps_ti[final_abund['STAR']=='cra2_gdr32672'][0]
...
for star_name in star_list:
    ...
    for plot_i, line in enumerate(lines):
        if not os.path.exists(f'{star}/abund_no_velshift/{star}_{element}_{line}_synth.txt'):
            ...
            abund_fitter.turbosynth_obj.set_abund('Ti', final_ti)
        ...
        plot_labels = [f'No Ti', f'[Ti/Fe] = {final_ti_fe-0.3:.2f}', f'[Ti/Fe] = {final_ti_fe:.2f}', f'[Ti/Fe] = {final_ti_fe+0.3:.2f}']
