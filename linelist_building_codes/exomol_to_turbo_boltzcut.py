...
mol_filename_list = ['12C2__8states',
                     ]
elemnums = ['0606.012012', ]
descriptions = ['Exomol Yurchenko 2018 McKemmish 2020',
                ]
outfile_titles = ['12C12C_boltz85', ]
...
for name, elemnum, source_description, outfile_title in zip(mol_filename_list,
    ...
    selection = (np.log(wavelengths/4000.) + loggfs - 5040.*eps/4000. > -8.5)

    wavelengths = wavelengths[selection]
    eps = eps[selection]
    loggfs = loggfs[selection]
    gus = gus[selection]
